...
public interface InfoResultFragmentCallback {

    void onInfoResultFragmentCallbackViewPkgbuildClicked(Uri viewPkgbuildUri);

    void onInfoResultFragmentCallbackViewChangesClicked(Uri viewChangesUri);
